...
//            }
//            if (mUploadCompletedFragment != null) {
//                mDownloadActivity.getFragmentManager().beginTransaction().hide(mUploadCompletedFragment).commit();
//                Log.d("Fragment", "隐藏mUploadCompletedFragment in");
//            }
...
//            if (mUploadCompletedFragment != null) {
//                mDownloadActivity.getFragmentManager().beginTransaction().hide(mUploadCompletedFragment).commit();
//                Log.d("Fragment", "隐藏mUploadCompletedFragment on");
//            }
//            if (mUploadingFragment != null) {
//                mDownloadActivity.getFragmentManager().beginTransaction().hide(mUploadingFragment).commit();
...
//        if (mUploadCompletedFragment == null) {
//            mUploadCompletedFragment = new UploadCompletedFragment();
//            Log.d("Fragment", "创建mUploadCompletedFragment in2");
//            mDownloadActivity.getFragmentManager().beginTransaction().add(R.id.ll_download_content, mUploadCompletedFragment).commit();
//            Log.d("Fragment", "添加mUploadCompletedFragment in2");
//            if (mDownloadCompletedFragment != null) {
//                mDownloadActivity.getFragmentManager().beginTransaction().hide(mDownloadCompletedFragment).commit();
//                Log.d("Fragment", "隐藏mDownloadCompletedFragment in");
//            }
...
//                Log.d("Fragment", "隐藏mUploadingFragment in");
//            }
//        } else if (!mUploadCompletedFragment.isVisible()) {
//            if (mDownloadCompletedFragment != null) {
//                mDownloadActivity.getFragmentManager().beginTransaction().hide(mDownloadCompletedFragment).commit();
//                Log.d("Fragment", "隐藏mDownloadCompletedFragment on");
//            }
...
//                Log.d("Fragment", "隐藏mUploadingFragment on");
//            }
//            mDownloadActivity.getFragmentManager().beginTransaction().show(mUploadCompletedFragment).commit();
//            Log.d("Fragment", "显示mUploadCompletedFragment on");
//        }
    }
//
