...
public class MineUserInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.d("Fragment生命周期管理", "onCreateView()触发-UserInfomation");
    ...
    public void onPause() {
        super.onPause();
        Log.d("Fragment生命周期管理", "onPause()触发-UserInfomation");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.d("Fragment生命周期管理", "onResume()触发-UserInfomation");
    }

    @Override
    public void onDestroy() {
        super.onDestroy();
        Log.d("Fragment生命周期管理", "onDestroy()触发-UserInfomation");
    }
}
