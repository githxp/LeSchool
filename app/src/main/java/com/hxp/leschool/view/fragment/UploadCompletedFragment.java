...
public class UploadCompletedFragment extends Fragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        UploadcompletedFmBinding uploadcompletedFmBinding = DataBindingUtil.inflate(inflater, R.layout.uploadcompleted_fm, container, false);
        UploadcompletedItemBinding uploadcompletedItemBinding = DataBindingUtil.inflate(inflater, R.layout.uploadcompleted_item, container, false);
        new UploadCompletedViewModel(this, uploadcompletedFmBinding,uploadcompletedItemBinding);
        Log.d("Fragment生命周期管理", "onCreateView()触发-DownloadCompletedFragment");
        return uploadcompletedFmBinding.getRoot();
    }
